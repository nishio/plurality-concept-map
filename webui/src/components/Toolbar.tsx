...
export const Toolbar: React.FC<ToolbarProps> = ({ selectedSection, onSectionChange }) => {
  const sections = [
    ...
    { value: 'extra-1', label: 'Extra-1: オードリー・タン「創造性は異なる視点が交差するところに花開く」' },
    { value: 'extra-2', label: 'Extra-2: E・グレン・ワイル「日本にデジタル民主主義の日が昇るとき」' },
    { value: 'extra-3', label: 'Extra-3: 鈴木健「Pluralityとは何か」日本語版解説' },
  ];
