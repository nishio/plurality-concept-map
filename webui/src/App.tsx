  ...
  return (
    <div id="app">
      <div id="sidebar">
        ...
        <ConceptDetails concept={selectedConcept} edge={selectedEdge} data={data} onConceptSelect={handleNodeSelect} onEdgeSelect={handleEdgeSelect} onSectionChange={handleSectionChange} currentSection={selectedSection} />
      </div>
